...
IndividualStop individualStopFromJson(String? str) =>
    IndividualStop.fromJson(json.decode(str ?? ""));
...
class IndividualStop {
  ...
  factory IndividualStop.fromJson(Map<String, dynamic> json) => IndividualStop(
        ...
        lineas: List<IndividualStopLinea>.from(
            json["lineas"].map((x) => IndividualStopLinea.fromJson(x))),
      );
...
class IndividualStopCoordenadas {
  ...
  factory IndividualStopCoordenadas.fromJson(Map<String, dynamic> json) =>
      IndividualStopCoordenadas(
...
class IndividualStopLinea {
  ...
  factory IndividualStopLinea.fromJson(Map<String, dynamic> json) =>
      IndividualStopLinea(
        id: json["id"],
